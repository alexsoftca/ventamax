...
export default function App() {
  ...
  const [tasaConfirmed, setTasaConfirmed] = useState(() => sessionStorage.getItem("vm_tasaOk") === "1");
  ...
  useEffect(() => { sessionStorage.setItem("vm_tasaOk", tasaConfirmed ? "1" : "0"); }, [tasaConfirmed]);
